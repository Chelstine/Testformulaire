        ...
        <CardContent className="pt-8 pb-8">
          <div className="text-center">
            ...
            <div className="bg-muted/50 rounded-xl p-8 mb-8 border border-border">
              ...
              <p className="text-lg md:text-xl font-mono font-black text-amber-500 tracking-wider drop-shadow-sm whitespace-nowrap overflow-hidden text-ellipsis">{matricule}</p>
            </div>
